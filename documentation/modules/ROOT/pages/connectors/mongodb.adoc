...
Unless overridden via the link-prefix}:{link-mongodb-connector}#mongodb-property-transaction-topic-prefix[`transaction.topic.prefix`] option,
...
|[[mongodb-property-transaction-topic-prefix]]<<mongodb-property-transaction-topic-prefix, `transaction.topic.prefix`>>
