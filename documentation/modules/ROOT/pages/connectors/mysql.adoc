...
Unless overridden via the link-prefix}:{link-mysql-connector}#mysql-property-transaction-topic-prefix[`transaction.topic.prefix`] option,
...
|[[mysql-property-transaction-topic-prefix]]<<mysql-property-transaction-topic-prefix, `transaction.topic.prefix`>>
