...
Unless overridden via the link-prefix}:{link-postgresql-connector}#postgresql-property-transaction-topic-prefix[`transaction.topic.prefix`] option,
...
|[[postgresql-property-transaction-topic-prefix]]<<postgresql-property-transaction-topic-prefix, `transaction.topic.prefix`>>
