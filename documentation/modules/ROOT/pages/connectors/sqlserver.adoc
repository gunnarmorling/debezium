...
Unless overridden via the link-prefix}:{link-sqlserver-connector}#sqlserver-property-transaction-topic-prefix[`transaction.topic.prefix`] option,
...
|[[sqlserver-property-transaction-topic-prefix]]<<sqlserver-property-transaction-topic-prefix, `transaction.topic.prefix`>>
